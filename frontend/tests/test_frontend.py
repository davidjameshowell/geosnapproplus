...
GLUETUN_PROXY_SERVERS_URL = os.getenv("GLUETUN_PROXY_SERVERS_URL", f"{FRONTEND_URL}/api/gluetun/servers")
...
class TestFrontendIntegration:
    ...
    def check_all_services_availability(self):
        ...
        services = [
            ...
            (GLUETUN_PROXY_SERVERS_URL, "Frontend Gluetun proxy"),
        ]
    ...
    def test_complete_workflow(self):
        ...
        # 1. Get available servers via the frontend proxy
        response = requests.get(GLUETUN_PROXY_SERVERS_URL)
        assert response.status_code == 200

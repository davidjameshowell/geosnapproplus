...
This directory contains integration tests for the GeoSnappro frontend application running in Kubernetes.
...
# Run the tests
FRONTEND_URL=http://localhost:5000 BACKEND_URL=http://localhost:8000 GLUETUN_API_URL=http://localhost:8001 pytest test_frontend.py -v
```
...
pytest test_frontend.py::TestFrontendConnectivity -v

# Run a specific test method
pytest test_frontend.py::TestFrontendConnectivity::test_frontend_responds -v

# Run tests matching a pattern
pytest test_frontend.py -k "connectivity" -v
```
